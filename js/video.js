$.ajax({
    ...
    success: function (data) {
    	...
    	for (var i = 0; i < article.length; i++) {
            ...
            // console.log(article[i].theme.name);
            // var p_photo = $("<img src='' alt='' class='p_photo_img'/>");
            // var p_video = $("<video src='' ></video>");
            //视频微博方时的图片
            var p_video1 = $("<video src='' poster='' controls='' playsinline -webkit-playsinline class='p_video1'></video>")
            // var p_video1 = $("<iframe src='frameborder='0' class='p_video1'></iframe>")

            // var main_a = $("<a href='' class='main_aa'></a>");
            ...
            // p_video.attr('src',article[i].video);
            ...
            // $('.main_div').append(p_video);
            $('.main_div').append(p_video1);
            // $('.main_div').append(main_a);
